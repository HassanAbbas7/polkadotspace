...
function ForgotPassword() {
  ...
  return (
    done? (<h1 className="text-center font-bold text-pink-500">Done! Please check your email for the confirmation link! <br /> check your spam folder if there is no email in inbox!</h1>) :
